            ...
            <div class="modal-header">
                ...
                <div class="ml-auto mt-n2"> 
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="editTipoUsuario" id="editComunidad"
                            value="Comunidad" required>
                        <label class="form-check-label" for="editComunidad">Comunidad</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="editTipoUsuario" id="editEscuela"
                            value="Escuela" required>
            ...
            <div class="modal-body">
                <form id="edit-usuario-form" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="editApellidoUsuario" name="ApellidoUsuario"
                            required>
                        <small id="errorApellidoEdit" class="error-message text-danger d-none"></small>
                    </div>
                    <div class="form-group">
                        <label for="editDireccionUsuario">Dirección</label>
                        <input type="text" class="form-control" id="editDireccionUsuario" name="DireccionUsuario"
                            required>
                        <small id="errorDireccionEdit" class="error-message text-danger d-none"></small>
                    </div>
                    <div class="form-group">
                        <label for="editTelefonoUsuario">Telefono</label>
                        <input type="text" class="form-control" id="editTelefonoUsuario" name="TelefonoUsuario"
                            required>
                    ...
                    <div class="form-group">
                        <label for="editNacimientoUsuario">Fecha de Nacimiento</label>
                        <input type="date" class="form-control" id="editNacimientoUsuario" name="NacimientoUsuario"
                            required>
                        <small id="errorNacimientoEdit" class="error-message text-danger d-none"></small>
                    </div>
